import { AssociateCreateCommand } from './associate-create-command-handler';
import v8n from 'v8n';
...
export default class AssociateCreateCommandValidator implements CommandValidator<AssociateCreateCommand> {
  ...
  constructor(readonly command: AssociateCreateCommand) {}
