    ...
    {!isMobile ? (
      ...
      <div className="aside-menu-mobile">
        {props.items.filter((x) => x.location === props.location).map((item: SidebarParentMenu) => [
          ...
          {/* <div className={`dropdown is-left ${isActive ? 'is-active': ''}`}>
            <div className="dropdown-trigger">
              <button className="button" onClick={() => setIsActive(!isActive)} aria-haspopup="true" aria-controls="dropdown-menu-associate">
                <Community />
              </button>
              <div className="dropdown-menu" id="dropdown-menu-associate" role="menu">
                <div className="dropdown-content">
                  <div className="dropdown-item">
                    <strong>
                      Socios
                  ...
                  <hr className="dropdown-divider" />
                  <button className="dropdown-item">&nbsp;&nbsp;Formato Excel</button>
                  <button className="dropdown-item">&nbsp;&nbsp;Formato PDF</button>
                </div>
              </div>
            </div>
          </div>&nbsp;&nbsp;
          <div className={`dropdown is-left ${isActive ? 'is-active': ''}`}>
            <div className="dropdown-trigger">
            <button className="button" onClick={() => setIsActive(!isActive)} aria-haspopup="true" aria-controls="dropdown-menu-savingfund">
              <PiggyBank />
            </button>
            <div className="dropdown-menu" id="dropdown-menu-savingfund" role="menu">
                <div className="dropdown-content">
                  <div className="dropdown-item">
                    <strong>
                      Socios
